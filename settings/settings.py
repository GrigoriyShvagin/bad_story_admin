...
#         'NAME': BASE_DIR / 'C:\AdminSocial\db.sqlite3',
#     }
# }
...
# Гриша можешь создать файл css и написать кастом
CKEDITOR_5_CUSTOM_CSS = 'path_to.css'
# CKEDITOR_5_FILE_STORAGE = "services.utils.CkeditorCustomStorage" # optional
